...
void loop()
{
  ...
  if (cm <= distanceThreshold && cm > distanceThreshold - 50) { //remove this chain later, as this is just a placeholder for later...
    digitalWrite(2, HIGH);
    digitalWrite(3, LOW);
    digitalWrite(4, LOW);
}
  ...
  delay(100); // Test out faster timings and slower timings. Test a way to not add delay without issues?
}
